				...
				<div className="flex items-center gap-2">
					{streaming ? (
						<>
							...
							<button
								onClick={cancel}
								className="rounded px-2 py-1 text-xs text-[#b05050] hover:bg-rose-50 transition-colors"
							>
								{'Stop'}
							</button>
						</>
						...
						<button
							...
							className="rounded-lg bg-[#5672a0] px-3 py-1.5 text-xs font-medium text-white hover:bg-[#4a6391] disabled:opacity-40 transition-colors"
						>
